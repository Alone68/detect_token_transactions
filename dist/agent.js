...
abiDecoder.addABI(consts_1.CONTRACT_ABI);
...
var handleTransaction = function (txEvent) { return __awaiter(void 0, void 0, void 0, function () {
    var findings, decodedSig;
    return __generator(this, function (_a) {
        findings = [];
        if (txEvent.transaction.to === consts_1.CONTRACT_ADDRESS || txEvent.transaction.from === consts_1.CONTRACT_ADDRESS) {
            decodedSig = abiDecoder.decodeMethod(txEvent.transaction.data);
            findings.push(forta_agent_1.Finding.fromObject({
                name: "ContractTransactionDetected",
                description: "Detected transaction for contract " + consts_1.CONTRACT_ADDRESS,
                alertId: "FORTA-170",
